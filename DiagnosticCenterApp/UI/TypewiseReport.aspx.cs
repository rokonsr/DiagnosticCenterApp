...
namespace DiagnosticCenterApp.UI
{
    public partial class TypewiseReport : System.Web.UI.Page
    {
        ...
        {
            List<TestType> testTypes = testTypeManager.GetTypewiseReport(Convert.ToDateTime(txtFromDate.Text), Convert.ToDateTime(txtToDate.Text));
            gvReportDetails.DataSource = testTypes;
        ...
        private void GeneratePdf()
        {
            ...
            PdfPCell cell1 = new PdfPCell(new Phrase("Type wise Report", new iTextSharp.text.Font(iTextSharp.text.Font.FontFamily.HELVETICA, 20)));
            cell1.Colspan = 3;
